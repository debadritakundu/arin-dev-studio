/* ═══════════════════════════════════════════════════════════════
   ARIN DEV STUDIO — Awwwards-Level JavaScript
   Refined animation orchestration, depth animations, performance.
   ═══════════════════════════════════════════════════════════════ */
...
if (!isTouchDevice) {
    ...
    // Smoother cursor with velocity-aware lag
    gsap.ticker.add(() => {
...
// Hero geometric shapes entrance (desktop only)
...
// ─── SplitType Typography Animations ─────────────────────────
document.fonts.ready.then(() => {
    ...
    splitElements.forEach((el) => {
        ...
        if (type === 'chars') {
            ...
            // Staggered word reveal with opacity cascade
...
// ─── Case Study Internal Scroll Animations ───────────────────
...
// Testimonial cards — enhanced with card depth animation
gsap.fromTo(
    '.t-card',
...
// ─── Scroll-linked Section Header Borders ────────────────────
